...
| Quality     | [`/probe-workflow`](https://github.com/kdeldycke/repomatic/blob/main/.claude/skills/probe-workflow/SKILL.md)               | Validate real-host behavior with a temporary workflow: measure, iterate, then retire it           |
