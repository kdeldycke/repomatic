...
| Quality     | [`/babysit-ci`](https://github.com/kdeldycke/repomatic/blob/main/.claude/skills/babysit-ci/SKILL.md)                   | Monitor CI tests, lint, and Nuitka binary-build workflows and loop until all stable jobs pass     |
