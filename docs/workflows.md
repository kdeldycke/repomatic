...
- Asks the API for the threads last updated before the cutoff, then inspects them oldest-first in batches (default: 200 per run) to stay within API rate limits
