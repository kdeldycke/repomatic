...
| Pinned actions                                                 | All `uses:` refs pinned to full commit SHAs (with the semver tag preserved as a trailing comment) via the [`sync-action-pins`](workflows.md#github-workflows-autofix-yaml-jobs) autofix job                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
The [`scan-virustotal`](workflows.md#github-workflows-release-engine-yaml-jobs) job in `_release-engine.yaml` uploads all compiled binaries to [VirusTotal](https://www.virustotal.com/) on every release. This seeds AV vendor databases to reduce false positive rates for downstream distributors (Chocolatey, Scoop, etc.).
