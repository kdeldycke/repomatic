...
| Checksums in installer scripts                                 | The [`update-checksums`](https://github.com/kdeldycke/repomatic/blob/main/repomatic/cli/setup.py) CLI command regenerates SHA-256 checksums for every binary tool; invoked automatically by [`sync-tool-versions`](workflows.md#github-workflows-sync-tool-versions-yaml-jobs) whenever a tool version is bumped                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
