...
| `peter-evans/create-pull-request`                                                                                      | Writes               | Commits verbatim what the job supplies, so the convention is the caller's                                                                                                                                                                       |
| [Codecov](https://docs.codecov.com)                                                                                    | Neither              | No commit-message parsing: coverage behavior is configured in `codecov.yml`                                                                                                                                                                     |
