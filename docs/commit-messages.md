...
| `repomatic pr-sync`                                                                                                    | Writes               | Commits verbatim what `repomatic pr-body` renders, so the convention is the template's                                                                                                                                                          |
| `peter-evans/create-pull-request`                                                                                      | Writes               | Same, on the three release-lane jobs still calling it                                                                                                                                                                                           |
