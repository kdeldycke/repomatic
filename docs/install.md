...
| Platform    | `arm64`                                                                                                                                              | `x64`                                                                                                                                            |
| :---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Linux**   | [Download `repomatic-7.16.1-linux-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-linux-arm64.bin)     | [Download `repomatic-7.16.1-linux-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-linux-x64.bin)     |
| **macOS**   | [Download `repomatic-7.16.1-macos-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-macos-arm64.bin)     | [Download `repomatic-7.16.1-macos-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-macos-x64.bin)     |
| **Windows** | [Download `repomatic-7.16.1-windows-arm64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-windows-arm64.exe) | [Download `repomatic-7.16.1-windows-x64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.1/repomatic-7.16.1-windows-x64.exe) |
...
```shell-session
$ gh attestation verify repomatic-7.16.1-linux-x64.bin --repo kdeldycke/repomatic --signer-repo kdeldycke/repomatic
```
