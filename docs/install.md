...
| `repomatic`         | Released   | `3.15` | `3.14` | `3.13` | `3.12` | `3.11` | `3.10` | `3.9` | `3.8` |
| :------------------ | :--------- | :----: | :----: | :----: | :----: | :----: | :----: | :---: | :---: |
| `7.16.x`            | 2026-09-18 |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |
| `4.25.x` → `7.15.x` | 2025-12-05 |   –    |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |
...
| Platform    | `arm64`                                                                                                                                              | `x64`                                                                                                                                            |
| :---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Linux**   | [Download `repomatic-7.16.2-linux-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-linux-arm64.bin)     | [Download `repomatic-7.16.2-linux-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-linux-x64.bin)     |
| **macOS**   | [Download `repomatic-7.16.2-macos-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-macos-arm64.bin)     | [Download `repomatic-7.16.2-macos-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-macos-x64.bin)     |
| **Windows** | [Download `repomatic-7.16.2-windows-arm64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-windows-arm64.exe) | [Download `repomatic-7.16.2-windows-x64.exe`](https://github.com/kdeldycke/repomatic/releases/download/v7.16.2/repomatic-7.16.2-windows-x64.exe) |
...
```shell-session
$ gh attestation verify repomatic-7.16.2-linux-x64.bin --repo kdeldycke/repomatic --signer-repo kdeldycke/repomatic
```
