...
| :---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Linux**   | [Download `repomatic-7.0.0-linux-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.0.0/repomatic-7.0.0-linux-arm64.bin)     | [Download `repomatic-7.0.0-linux-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.0.0/repomatic-7.0.0-linux-x64.bin)     |
| **macOS**   | [Download `repomatic-7.0.0-macos-arm64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.0.0/repomatic-7.0.0-macos-arm64.bin)     | [Download `repomatic-7.0.0-macos-x64.bin`](https://github.com/kdeldycke/repomatic/releases/download/v7.0.0/repomatic-7.0.0-macos-x64.bin)     |
