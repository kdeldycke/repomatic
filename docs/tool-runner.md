...
[Nuitka#3909](https://github.com/Nuitka/Nuitka/issues/3909) shipped in `4.2`, but only for `--project` builds, which take their entry points from the project configuration. repomatic names a main module on the command line, so the nuitka bridge stays.
```
...
| [nuitka](https://github.com/Nuitka/Nuitka)                                          | Standalone binary compilation       | [`[tool.nuitka]`](https://nuitka.net/doc/user-manual.html)                                           | [repomatic bridge](#nuitka) → CLI flags ([native support is `--project`-only: Nuitka#3909](https://github.com/Nuitka/Nuitka/issues/3909)) |
