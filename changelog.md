...
- Every GitHub release now carries an attested `repomatic-plugin.zip` asset, which is what the plugin marketplace installs from. New `pack-plugin` command builds it.
